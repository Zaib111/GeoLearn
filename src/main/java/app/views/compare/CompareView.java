...
public class CompareView extends AbstractView {
    ...
    public void onViewOpened(String param) {
        // When Compare view is opened from Home or elsewhere,
        // always reset to the selection UI and show the global back button.
        buildSelectionUI();
        navigationService.setBackButtonVisible(true);
    ...
    private void showComparisonInSamePanel(CompareState state) {
        ...
        // Hide the global back button while we're on the comparison screen;
        // the in-view "Back to Country Selection" will handle going back.
        navigationService.setBackButtonVisible(false);
        ...
        backToSelectionButton.addActionListener(e -> {
            // When going back to selection, restore the global back button
            buildSelectionUI();
            navigationService.setBackButtonVisible(true);
            compareController.loadAvailableCountries();
        });
